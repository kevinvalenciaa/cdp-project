...
// Embedded CSS for minimal custom styles (SSR-guarded)
const styles = `
  textarea.ai-prompt-textarea::-webkit-scrollbar {
    width: 6px;
  }
  textarea.ai-prompt-textarea::-webkit-scrollbar-track {
    background: transparent;
  }
  textarea.ai-prompt-textarea::-webkit-scrollbar-thumb {
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 z-10 rounded-full bg-muted/80 p-2 transition-all hover:bg-muted">
            ...
            <PromptInputAction tooltip="Upload image">
              ...
              >
                ...
                <input
                  ...
                  className="hidden"
                  onChange={(e) => {
                    if (e.target.files && e.target.files.length > 0 && e.target.files[0]) processFile(e.target.files[0]);
